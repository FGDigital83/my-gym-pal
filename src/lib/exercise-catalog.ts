...
export const DEFAULT_PICKS: Partial<Record<Muscle, string[]>> = {
  ...
  Hombro: ["Press militar con barra de pie", "Elevaciones laterales con mancuernas", "Pájaros con mancuernas", "Elevaciones frontales con mancuernas"],
  "Bíceps": ["Curl con barra Z", "Curl martillo", "Curl predicador con barra", "Curl con mancuernas"],
